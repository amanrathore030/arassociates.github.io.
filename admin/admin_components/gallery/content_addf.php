...
if(isset($_POST['submit'])){
  ...
  $update="UPDATE `tbl_gallery` SET `fld_name`='$fld_name',`image`='$img_fld2' WHERE `id`='$id'";
   ...
   <tr>
      <td height="21" align="left" class="txt">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      <td width="76%" height="25"><img src="images/heading_icon.gif" width="16" height="16" hspace="5">Edit Gallery </td>
...
$sel="SELECT * FROM `tbl_gallery` WHERE `id`='$id'";
