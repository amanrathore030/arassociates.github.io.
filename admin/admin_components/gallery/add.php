...
if(isset($_POST['submit'])){
  ...
  $insert = "INSERT INTO `tbl_gallery`( `fld_name`, `image`) VALUES ('$fld_name', '$img_fld2')";
   ...
   <tr>
      <td height="21" align="left" class="txt">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      <td width="76%" height="25"><img src="images/heading_icon.gif" width="16" height="16" hspace="5">Manage Gallery </td>
                      <td width="24%" align="right"><input name="b1" type="button" class="button1" id="b1" value="Manage About" onClick="location.href='default.php?option=gallery&page=content_list'">
                      &nbsp;</td>
                    </tr>
             </table>
	   </td>
  ...
  <tr>
   ...
   <td height="400" align="center" valign="top">
     <table width="68%" border="0" align=center cellpadding="4" cellspacing="0" class="greyBorder">
       <form method="POST" enctype="multipart/form-data" action="default.php?option=gallery&page=add"  >
       
       <tr align="left"> 
					<td height="25" colspan="2" class="blueBackground">Add Gallery</td>
      </tr>
      ...
      <tr class="evenRow">
       ...
       <tr class="oddRow">
				  <td width="35%" align="right" valign="top" class="bldTxt">Image Name</td>
