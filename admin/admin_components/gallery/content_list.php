...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
             ...
             <td width="24%" align="right" style="padding-right:20px;"><input name="b1" type="button" class="button1" id="b1" value="Add Gallery" onClick="location.href='default.php?option=gallery&page=add'"></td>
             </tr>
...
<tr>
<td>
<form name="frm_list" method="post" action="default.php?option=gallery&page=content_del">
 <table width="98%" align="center" cellpadding="4" cellspacing="1" class="greyBorder">
     <tr  class="blueBackground">
         ...
         <th width="50%"  align="left">Image </td>
...
?>
     ...
     <tr class="<?php echo $className?>">
         ...
         <td align="left" valign="top" class="txt"><?php echo $row['fld_name'];?></td>
         <td align="left" valign="top" class="txt"><?php echo $row['image'];?></td>
        ...
        <?php }else{?>
         ...
         <td align="center" valign="top" class="txt"><a href="default.php?option=gallery&page=content_addf&id=<?php echo $row['id']; ?>">edit</a></td>
         <td align="center" valign="top" class="txt"><a href="default.php?option=gallery&page=content_del&id=<?php echo $row['id']; ?>">Delete</a></td>
     </tr>
<?php
}
?>
