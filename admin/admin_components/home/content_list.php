...
<tr class="<?php print $className?>">
         ...
         <td align="left" valign="top" class="txt"><?php echo $row['fld_title'];?></td>
        ...
        <?php }else{?>
         ...
         <td align="center" valign="top" class="txt"><a href="default.php?option=home&page=add&id=<?php echo $row['fld_id']; ?>">edit</a></td>
         <td align="center" valign="top" class="txt"><a href="default.php?option=home&page=content_del&id=<?php echo $row['fld_id']; ?>">Delete</a></td>
     </tr>
<?php
}
?>
