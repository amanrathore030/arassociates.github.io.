...
<tr class="<?php print $className?>">
         ...
         <td align="left" valign="top" class="txt"><?php echo $row['fld_contact'];?></td>
        ...
        <?php }else{?>
         ...
         <td align="center" valign="top" class="txt"><a href="default.php?option=contact&page=add&id=<?php echo $row['id']; ?>">edit</a></td>
         <td align="center" valign="top" class="txt"><a href="default.php?option=contact&page=content_list&id=<?php echo $row['id']; ?>">Delete</a></td>
     </tr>
<?php
}
?>
