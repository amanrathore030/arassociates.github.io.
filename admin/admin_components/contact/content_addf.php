      ...
      <td height="21" align="left" class="txt">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      ...
                      <td width="24%" align="right"><input name="b1" type="button" class="button1" id="b1" value="Manage About" onClick="location.href='default.php?option=contact&page=content_list'">
                      &nbsp;</td>
                    </tr>
             </table>
	   </td>
  ...
  <tr>
   ...
   <td height="400" align="center" valign="top">
     <table width="68%" border="0" align=center cellpadding="4" cellspacing="0" class="greyBorder">
       <form method="post" action="default.php?option=contact&page=add" >
       <tr align="left"> 
      ...
      <tr> 
       ...
       <tr class="oddRow">
				  ...
				  <td width="65%" align="left" class="txt"><input name="fld_contact" type="text" class="txtfld" size="50" value="<?php echo $row['fld_contact'];?>"></td>
			    </tr>
