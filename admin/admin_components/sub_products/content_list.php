...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
             ...
             <td width="24%" align="right" style="padding-right:20px;"><input name="b1" type="button" class="button1" id="b1" value="Add Certificate" onClick="location.href='default.php?option=sub_products&page=add'"></td>
             </tr>
...
<tr class="<?php print $className?>">
        ...
        <?php }else{?>
         ...
         <td align="center" valign="top" class="txt"><a href="default.php?option=sub_products&page=content_addf&id=<?php echo $row['id']; ?>">edit</a></td>
         <td align="center" valign="top" class="txt"><a href="default.php?option=sub_products&page=content_del&id=<?php echo $row['id']; ?>">Delete</a></td>
     </tr>
<?php
}
?>
