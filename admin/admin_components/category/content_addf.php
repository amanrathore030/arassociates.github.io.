...
if(isset($_POST['submit'])){
  ...
  $update="UPDATE `tbl_category` SET `fld_category`='$fld_category', `fld_order`='$fld_order', `image`='$img_fld2' WHERE `id`='$id'";
      ...
      <td height="21" align="left" class="txt">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      ...
                      <td width="24%" align="right"><input name="b1" type="button" class="button1" id="b1" value="Manage Certificate" onClick="location.href='default.php?option=category&page=content_list'">
                      &nbsp;</td>
                    </tr>
             </table>
	   </td>
...
<form  method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">   
      ...
      <tr class="evenRow">
       ...
       <tr class="oddRow">
				  ...
				  <td width="65%" align="left" class="txt"><input name="fld_category" type="text" class="txtfld" size="50" value="<?php echo $row['fld_category'];?>"></td>
			    </tr>
      
          <tr class="oddRow">
				  <td width="35%" align="right" valign="top" class="bldTxt">Order By</td>
				  <td width="65%" align="left" class="txt"><input name="fld_order" type="text" class="txtfld" size="50" value="<?php echo $row['fld_order'];?>"></td>
			    </tr>
