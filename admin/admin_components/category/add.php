...
if(isset($_POST['submit'])){
  ...
  $img_fld="../uploaded_files/category/".$image;
  $img_fld2="../uploaded_files/category/".$image;

  
  move_uploaded_file($_FILES['fld_image']['tmp_name'],$img_fld2);


  $insert = "INSERT INTO `tbl_category`( `fld_category`, `fld_order`, `image`) VALUES ('$fld_category','$fld_order', '$img_fld2')";
      ...
      <td height="21" align="left" class="txt">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      ...
                      <td width="24%" align="right"><input name="b1" type="button" class="button1" id="b1" value="Manage About" onClick="location.href='default.php?option=category&page=content_list'">
                      &nbsp;</td>
                    </tr>
             </table>
	   </td>
  ...
  <tr>
   ...
   <td height="400" align="center" valign="top">
     <table width="68%" border="0" align=center cellpadding="4" cellspacing="0" class="greyBorder">
       <form method="POST" enctype="multipart/form-data" action="default.php?option=category&page=add"  >
      ...
      <tr class="evenRow">
       ...
       <tr class="oddRow">
				  <td width="35%" align="right" valign="top" class="bldTxt">Category Name</td>
				  <td width="65%" align="left" class="txt"><input name="fld_category" type="text" class="txtfld" size="50"></td>
			    </tr>
        
          <tr class="oddRow">
				  <td align="right" valign="top" class="bldTxt">Order By	</td>
				  <td align="left" class="txt"><input type="number"  class="txtfld" size="10" name="fld_order"></td>
			    </tr>


        <tr class="oddRow">
				  <td align="right" valign="top" class="bldTxt">Category Image</td>
